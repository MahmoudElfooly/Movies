...
import 'package:hackathon_fatura/models/error_response.dart';
import 'package:hackathon_fatura/models/movieModel.dart';
import 'package:http/http.dart' as http;

import 'api_constant.dart';

enum RequestType { GetMovieData }
  ...
  try {
    ...
    if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
      try {
        ...
        switch (requestType) {
          case RequestType.GetMovieData:
            return movieResponse(response.body);
          default:
            {}
        }
